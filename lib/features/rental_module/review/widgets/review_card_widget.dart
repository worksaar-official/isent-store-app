...
import 'package:sixam_mart_store/features/rental_module/review/screens/taxi_review_reply_screen.dart';
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Text(review.vehicleName ?? '', style: robotoBold, overflow: TextOverflow.ellipsis, maxLines: 1),
            ),
            const SizedBox(width: Dimensions.paddingSizeDefault),

            Get.find<SplashController>().configModel!.storeReviewReply ?? false ? CustomButtonWidget(
              onPressed: () {
                Get.to(() => TaxiReviewReplyScreen(isGiveReply: review.reply != null ? false : true, review: review, providerReviewReplyStatus: Get.find<SplashController>().configModel!.storeReviewReply!));
              },
              width: 95, height: 40,
              radius: 8,
